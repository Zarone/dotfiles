...
vim.keymap.set("n", "<leader>4", function() harpoon:list():select(7) end)
vim.keymap.set("n", "<leader>3", function() harpoon:list():select(8) end)
vim.keymap.set("n", "<leader>2", function() harpoon:list():select(9) end)
vim.keymap.set("n", "<leader>1", function() harpoon:list():select(10) end)
