local function open_reading_list()
  ...
  local go_file = vim.fn.expand("~/dotfiles/nvim/lua/plugins/paper/main.go")
  ...
  vim.defer_fn(function()
    ...
    vim.fn.jobstart({open_cmd, "http://127.0.0.1:5001"}, {detach = true})
  end, 500)
end

vim.keymap.set("n", "<leader>wp", open_reading_list, {desc = "Open reading list web UI"})
